...
public class PlacesActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(xyz.fcampbell.android.rxgms.sample.R.layout.activity_places);
        currentPlaceView = (TextView) findViewById(xyz.fcampbell.android.rxgms.sample.R.id.current_place_view);
        queryView = (EditText) findViewById(xyz.fcampbell.android.rxgms.sample.R.id.place_query_view);
        placeSuggestionsList = (ListView) findViewById(xyz.fcampbell.android.rxgms.sample.R.id.place_suggestions_list);
