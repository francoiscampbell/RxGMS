...
import static xyz.fcampbell.rxgms.sample.utils.UnsubscribeIfPresent.unsubscribe;
...
public class MockLocationsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(xyz.fcampbell.android.rxgms.sample.R.layout.activity_mocklocations);
    ...
    private void initViews() {
        ...
        mockLocationView = (TextView) findViewById(xyz.fcampbell.android.rxgms.sample.R.id.mock_location_view);
        updatedLocationView = (TextView) findViewById(xyz.fcampbell.android.rxgms.sample.R.id.updated_location_view);
        mockModeToggleButton = (ToggleButton) findViewById(xyz.fcampbell.android.rxgms.sample.R.id.toggle_button);
        setLocationButton = (Button) findViewById(xyz.fcampbell.android.rxgms.sample.R.id.set_location_button);
