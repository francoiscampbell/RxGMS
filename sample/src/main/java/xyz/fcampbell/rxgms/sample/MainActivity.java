...
import xyz.fcampbell.rxgms.sample.utils.AddressToStringFunc;
import xyz.fcampbell.rxgms.sample.utils.DetectedActivityToString;
...
import xyz.fcampbell.rxgms.sample.utils.ToMostProbableActivity;
...
public class MainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(xyz.fcampbell.android.rxgms.sample.R.layout.activity_main);

        lastKnownLocationView = (TextView) findViewById(xyz.fcampbell.android.rxgms.sample.R.id.last_known_location_view);
        updatableLocationView = (TextView) findViewById(xyz.fcampbell.android.rxgms.sample.R.id.updated_location_view);
        addressLocationView = (TextView) findViewById(xyz.fcampbell.android.rxgms.sample.R.id.address_for_location_view);
        currentActivityView = (TextView) findViewById(xyz.fcampbell.android.rxgms.sample.R.id.activity_recent_view);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.add("Places").setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                if (TextUtils.isEmpty(getString(xyz.fcampbell.android.rxgms.sample.R.string.API_KEY))) {
