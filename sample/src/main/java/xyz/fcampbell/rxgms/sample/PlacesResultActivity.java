...
public class PlacesResultActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(xyz.fcampbell.android.rxgms.sample.R.layout.activity_places_result);

        placeNameView = (TextView) findViewById(xyz.fcampbell.android.rxgms.sample.R.id.place_name_view);
        placeLocationView = (TextView) findViewById(xyz.fcampbell.android.rxgms.sample.R.id.place_location_view);
        placeAddressView = (TextView) findViewById(xyz.fcampbell.android.rxgms.sample.R.id.place_address_view);
